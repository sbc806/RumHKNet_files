...
total_ko=pd.read_csv("../../../histidine_other_software/total_KO.csv",header=None)
total_blastp3050=pd.read_csv("../../../histidine_other_software/total_blastp3050.csv",header=None)
