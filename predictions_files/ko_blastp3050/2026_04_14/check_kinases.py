...
pd.DataFrame(blastp.values[~blastp_contained]).to_csv("blastp_missing.csv",index=False)
pd.DataFrame(kofamscan.values[~kofamscan_contained]).to_csv("kofamscan_missing.csv",index=False)
