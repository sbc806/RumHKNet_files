...
total_ko_df["prob_step_1"]=step_1_predicted_rbag_df[total_ko_df["seq_id"].values)[0]]["prob"]
total_blastp3050_df["prob_step_1"]=step_1_predicted_rbag_df[total_blastp3050_df["seq_id"].values)[0]]["prob"]
