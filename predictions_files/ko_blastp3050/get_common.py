...
step_1_clustered-newrun_rbags_df=pd.read_csv("../../../RumHKNet_csv/step_1_clustered_newrun_rbags_predicted_03.csv")

total_ko_df=pd.read_csv("../../../histidine_other_software/total_KO.txt",header=None)
total_blastp3050_df=pd.read_csv("../../../histidine_other_software/total_vlastp3050.txt",header=None)

total_ko_contained=total_ko_df.isin(stpe_1_clustered_newrun_rbags_df["seq_id"].values)
