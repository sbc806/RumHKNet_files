...
print(np.unique(step_3_02_df_new["pred"]))
print(np.unique(step_3_02_df_new["pred_other"]))
...
step_3_02_small_remaining_df_new=step_3_02_df_new_remaining[step_3_02_df_new_remaining["seq"].str.len()<=1500]
step_3_02_large_remaining_df_new=step_3_02_df_new_remaining[step_3_02_df_new_remaining["seq"].str.len()>1500]
