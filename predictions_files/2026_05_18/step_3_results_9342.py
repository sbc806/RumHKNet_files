...
all_predictions=pd.read_csv(os.path.join(predictions_path,"9342_all_proteins_newrun_step_2_histidine_kinase_small_1_0123456_2_034_predicted_02.csv"))
...
predictions_remaining=pd.read_csv(os.path.join(predictions_path,"9342_all_proteins_newrun_step_2_histidine_kinase_remaining_predicted_02.csv"))
print("Number of predictions:",len(predictions_remaining))
