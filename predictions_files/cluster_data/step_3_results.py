...
import sys
sys.path.append("..")
from predictions_helpers import check_specific, df_to_fasta, reverse_dict, add_label
...
df_to_fasta(step_3,"/home/schen123/projects/rrg-guanuofa/schen123/kinases/cluster_data_predictions/RumHKNet_predictions/step_1_02_step_2_02/newadd_155098MAGs_step_3_histidine_kinase_family.fasta",extra_column="pred_other")
