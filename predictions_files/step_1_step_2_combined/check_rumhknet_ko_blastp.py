...
final_sequences_method=final_sequences[final_sequences_contained]
print(np.sum(final_sequences["seq"].isin(method["seq"].values)),np.sum(~final_sequences["seq"].isin(method["seq"].values)))
