...
step_1_rbag_02_small_df=step_1_rbag_02_df[step_1_rbag_02_df["seq"].str.len()<=1500].iloc[:,0:2]
step_1_rbag_02_large_df=step_1_rbag_02_df[step_1_rbag_02_df["seq"].str.len()>1500].iloc[:,0:2]
